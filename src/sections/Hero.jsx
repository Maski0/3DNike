...
import CanvasModel from "../3dCanvas/Canvas";
    ...
    return (
        ...
        >
            <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
                ...
                <p className="font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w-sm"> Get the Latest Nike Arraivals , Best Quality ,Comfort and innovation for your active life</p>
